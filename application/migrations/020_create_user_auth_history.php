...
class Migration_create_user_auth_history extends CI_Migration
{
	public function __construct()
	{
		parent::__construct();
		$this->load->dbforge();
		$this->table_name = 'users_login_history';
	}
	...
	public function up()
	{
		$this->dbforge->add_field([
			...
			'login_type' => ['type' => 'TINYINT', 'constraint' => '1', 'null' => TRUE, 'default' => 1, 'comment' => '1-CREDENTIAL, 2-SOCIALITE, 3-TOKEN'],
