...
class Migration_create_entity_files extends CI_Migration
{
	...
	public function up()
	{
		$this->dbforge->add_field([
			...
			'file_compression' => ['type' => 'TINYINT', 'constraint' => '1', 'null' => TRUE, 'default' => 1, 'comment' => '1 = full size only, 2 = full size & compressed, 3 = full size, compressed & thumbnail'],
			'files_folder' => ['type' => 'VARCHAR', 'constraint' => '150', 'null' => TRUE, 'comment' => ''],
			'files_path' => ['type' => 'VARCHAR', 'constraint' => '250', 'null' => TRUE, 'comment' => ''],
			'file_path_is_url' => ['type' => 'TINYINT', 'constraint' => '1', 'null' => TRUE, 'default' => 0, 'comment' => ''],
