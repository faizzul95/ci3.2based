...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <!-- <p class="mt-3 fs-15 fw-medium">ALL IN ONE SOLUTION</p> -->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2">
                                    <form action="formAuthentication" method="POST">
                                        <div class="mb-3">
    ...
    <!-- password-addon init -->
    <script src="{{ asset('template/js/pages/passowrd-create.init.js') }}"></script>
